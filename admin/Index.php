...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	$stmt->execute(array($txtUsername,$txtPassword));
	...
	if($affected_rows >= 1) 
	{
		...
		$_SESSION['full_name'] = $row['staff_name'];
		$_SESSION['user_identity'] = $row['staff_id'];
		
		$_SESSION['faculty'] = $row['staff_faculty'];
		$_SESSION['department'] = $row['staff_dept'];
		$_SESSION['level'] = $row['student_level'];
		$_SESSION['course_upload'] = $row['course_upload'];
		$_SESSION['staff_registration'] = $row['staff_registration'];
...
<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:green" role="navigation" >
            <div class="navbar-header" style="background-color:grey">
				...
				<a class="navbar-brand" style="font-size:20px;font-weight:bold;color:white" href="#">Abubakar Tafawa Balewa University, Bauchi </a>
	...
	<!-- middle content starts here where vertical nav slides and news ticker statr -->
		<div class="row">
			...
			<div  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:5px; padding-bottom:10px; background-color:grey;margin-bottom:1%">
							<h3 style="text-align:center;padding-top:5px; padding-bottom:25px;color:yellow" >Satff Login Platform</h3>	
				</div>
				<div  class="col-sm-12 col-md-12 col-lg-12"  class="col-lg-12" style="width:100%; padding-top:10px; padding-left:10px; padding-bottom:10px; background-color:CadetBlue;margin-bottom:1%">
								...
								<div class="form-group">
														<label for="txtUsername" class="control-label col-xs-5">User Name :<span style="color:red" class"require">*</span></label>
														<div class="col-xs-7">
															<div class="input-group">
																<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
																<input type="text" class="form-control"  id="txtUsername" name="txtUsername" value="<?php echo $txtUsername; ?>" placeholder="Enter Your User Name">
															</div>
														</div>
								</div>
				<div class="form-group">
				...
				<div class="form-group">
														...
														<div class="col-xs-7">
															<a href="Retrieve_Login_Details.php" style="color:yellow">Change Password </a>
														</div>
								</div>
